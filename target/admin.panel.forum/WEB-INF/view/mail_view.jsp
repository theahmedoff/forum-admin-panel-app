            ...
            <section class="panel">
              <div class="panel-body">
                <ul class="nav nav-pills nav-stacked labels-info ">
                  ...
                  <li>
                    <a href="#">
                        <img src="${pageContext.request.contextPath}/resources/img/friends/fr-05.jpg" class="img-circle" width="20">David
            ...
            <section class="panel">
              ...
              <div class="panel-body ">
                ...
                <div class="mail-sender">
                  <div class="row">
                    <div class="col-md-8">
                      <img src="${pageContext.request.contextPath}/resources/img/ui-zac.jpg" alt="">
                  ...
                  <ul>
                    <li>
                      <a class="atch-thumb" href="#">
                        <img src="${pageContext.request.contextPath}/resources/img/instagram.jpg">
                        </a>
                      <a class="name" href="#">
                        IMG_001.jpg
                        <span>20KB</span>
                    ...
                    <li>
                      <a class="atch-thumb" href="#">
                        <img src="${pageContext.request.contextPath}/resources/img/weather.jpg">
                        </a>
                      <a class="name" href="#">
                        IMG_001.jpg
                        <span>20KB</span>
