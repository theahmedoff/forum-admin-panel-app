        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="index.jsp#">See all messages
                  </a>
              </li>
            </ul>
          </li>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered">
            <a href="profile.jsp"><img src="img/ui-sam.jpg" class="img-circle" width="80"></a>
          </p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li>
                <a href="lock_screen.jsp">Lock Screen</a>
              </li>
              <li>
              ...
              <li>
                <a href="404.jsp">404 Error</a>
              </li>
              <li>
                <a href="500.jsp">500 Error</a>
              </li>
            </ul>
          </li>
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li>
                <a href="form_component.jsp">Form Components</a>
              </li>
              <li>
                <a href="advanced_form_components.jsp">Advanced Components</a>
              </li>
              <li>
                <a href="form_validation.jsp">Form Validation</a>
              </li>
            </ul>
          </li>
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active">
                <a href="basic_table.jsp">Basic Table</a>
              </li>
              <li>
                <a href="responsive_table.jsp">Responsive Table</a>
              </li>
              <li>
                <a href="advanced_table.jsp">Advanced Table</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  <tr>
                    <td>
                      <a href="basic_table.jsp#">Company Ltd</a>
                    </td>
                  ...
                  <tr>
                    <td>
                      <a href="basic_table.jsp#">Dashio ext</a>
                    </td>
                    <td class="hidden-phone">Lorem Ipsum dolor</td>
                    <td>22000.50$ </td>
                    <td><span class="label label-success label-mini">Paid</span></td>
                  ...
                  <tr>
                    <td>
                      <a href="basic_table.jsp#">Total Ltd</a>
                    </td>
                    <td class="hidden-phone">Lorem Ipsum dolor</td>
                    <td>12120.00$ </td>
                    <td><span class="label label-warning label-mini">Due</span></td>
