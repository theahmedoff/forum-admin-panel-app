...
<header class="header black-bg">
    ...
    <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
            <!-- settings start -->
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="${pageContext.request.contextPath}/ns?action=index">
            ...
            <li id="header_inbox_bar" class="dropdown">
                ...
                <ul class="dropdown-menu extended inbox">
                  ...
                  Please, answer asap.
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/ns?action=index">See all messages</a>
                    </li>
                </ul>
            </li>
            <!-- inbox dropdown end -->
            ...
            <li id="header_notification_bar" class="dropdown">
                ...
                <ul class="dropdown-menu extended notification">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/ns?action=index">See all notifications</a>
                    </li>
                </ul>
            </li>
    ...
    <div class="top-menu">
        <ul class="nav pull-right top-menu">
            <li><a class="logout" href="${pageContext.request.contextPath}/ns?action=login">Logout</a></li>
        </ul>
    </div>
</header>
<!--header end-->
